...
function Show-Menu {
    do {
        ...
        Write-Host "=======================================" -ForegroundColor Yellow
        Write-Host ""
        Write-Host "1. Exécuter le script complet d'administration AD (OPTIMISÉ)" -ForegroundColor Cyan
        ...
        Write-Host ""
        Write-Host "AMÉLIORATIONS v2.0 :" -ForegroundColor Green
        Write-Host "- Workflow optimisé : GG_ puis DL_ automatiques" -ForegroundColor Gray
        Write-Host "- Association automatique par service" -ForegroundColor Gray
        Write-Host "- Logs automatiques dans C:\" -ForegroundColor Gray
        Write-Host "- Sélection multiple pour associations" -ForegroundColor Gray
        Write-Host ""
...
# ============================================================================
# EXEMPLE DE FICHIER CSV AMÉLIORÉ
# ============================================================================
...
Write-Host "- Création GG_ puis proposition automatique des DL_" -ForegroundColor Gray
Write-Host "- Association automatique par service (étape 4 supprimée)" -ForegroundColor Gray
Write-Host "- Sélection multiple pour les associations de groupes" -ForegroundColor Gray
Write-Host "- Logs automatiques sauvegardés dans C:\" -ForegroundColor Gray
Write-Host "- Interface simplifiée et confirmations par défaut" -ForegroundColor Gray
Write-Host ""
...
function Show-Menu {
    do {
        Show-Banner
        Write-Host "MENU PRINCIPAL - ACTIVE DIRECTORY " -ForegroundColor Yellow
        Write-Host "=======================================" -ForegroundColor Yellow
        Write-Host ""
